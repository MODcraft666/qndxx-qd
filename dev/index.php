<!doctype html>
<?php
$classes=array("1n4"=>"一年四班","test"=>"测试");
?>
<html lang="en">
            ...
            <div class="front-content">
                ...
                <div class="footer">
                    ...
                    <div class="animation-container animation-fade-up" data-animation-delay="1200">
                        ...
                        <p>© 2020 1-4 | LiYueyang - NCGstudio <a href="./down_none.php?class=<?php echo $_GET['class']; ?>" target="_blank" title="未登记">点击这里查看未登记的同学</a> - 统计未学习同学很累？<a href="./rj.php" title="入驻" target="_blank">我也要使用！</a></p>
